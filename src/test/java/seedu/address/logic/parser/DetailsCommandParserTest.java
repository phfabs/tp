 ...
 * outside of the DetailsCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DetailsCommand, and therefore we test only one of them.
